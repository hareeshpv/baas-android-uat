...
class CardApisUnitTests {
   ...
   assertion to check if the result is as expected.
    ...
    fun testForSetPinDataApi() {
        var call: Response<com.payu.baas.coreUI.nonUI.model.responseModels.CardSetPinResponse> = mockApiCaller!!.callForSetPinDataApi().execute()
        TestCase.assertNotNull(
    ...
    fun testForSetCardLimitApi() {
        var call: Response<com.payu.baas.coreUI.nonUI.model.responseModels.SetLimitResponse> =
    ...
    fun testForGetCardLimitApi() {
        var call: Response<com.payu.baas.coreUI.nonUI.model.responseModels.GetLimitsResponse> =
    ...
    fun testForUpdateCardPinSetStatusApi() {
        var call: Response<com.payu.baas.coreUI.nonUI.model.responseModels.UpdateCardPinSetStatusResponse> =
    ...
    fun testForGetCardPinApi() {
        var call: Response<com.payu.baas.coreUI.nonUI.model.responseModels.GetCardPinStatusResponse> =
