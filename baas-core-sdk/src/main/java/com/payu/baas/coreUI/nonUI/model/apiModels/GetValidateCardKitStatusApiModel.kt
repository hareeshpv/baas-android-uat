...
import com.payu.baas.coreUI.nonUI.model.responseModels.GetValidateCardKitStatusResponse

class GetValidateCardKitStatusApiModel(
    context: Context,
    requestMap: HashMap<String, Any>,
    sdkCallback: SdkCallback
) : ApiModel(context, requestMap, ApiName.GET_VALIDATE_CARD_KIT_STATUS, sdkCallback) {

    override fun getRelativeUrl(): String = "card/status"
    override fun getRequestMethod(): RequestMethod = RequestMethod.GET
    override fun getApiType(): ApiType = ApiType.POST_LOGIN
    override fun getTokenType(): TokenType = TokenType.ACCESS_TOKEN
    override fun getRequestData(): String = ""
    override fun getResponseModel(): ApiResponse = GetValidateCardKitStatusResponse()
}