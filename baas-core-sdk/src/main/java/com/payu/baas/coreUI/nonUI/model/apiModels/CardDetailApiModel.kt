...
import com.payu.baas.coreUI.nonUI.model.responseModels.CardDetailResponse

class CardDetailApiModel(
    context: Context,
    ...
    override fun getResponseModel(): ApiResponse = CardDetailResponse()
}