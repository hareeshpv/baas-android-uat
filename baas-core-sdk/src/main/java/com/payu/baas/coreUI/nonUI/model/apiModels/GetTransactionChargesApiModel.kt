...
import com.payu.baas.coreUI.nonUI.model.responseModels.GetTransactionChargesResponse

class GetTransactionChargesApiModel(
    context: Context,
    requestMap: HashMap<String, Any>,
    sdkCallback: SdkCallback
) : ApiModel(context, requestMap, ApiName.GET_TRANSACTION_CHARGES, sdkCallback) {

    override fun getRelativeUrl(): String = "transaction/charges"
    override fun getRequestMethod(): RequestMethod = RequestMethod.GET
    override fun getApiType(): ApiType = ApiType.POST_LOGIN
    override fun getTokenType(): TokenType = TokenType.ACCESS_TOKEN
    override fun getRequestData(): String = ""
    override fun getResponseModel(): ApiResponse = GetTransactionChargesResponse()
}