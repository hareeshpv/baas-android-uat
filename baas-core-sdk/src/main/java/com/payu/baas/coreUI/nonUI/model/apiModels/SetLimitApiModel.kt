...
import com.payu.baas.coreUI.nonUI.model.responseModels.SetLimitResponse

class SetLimitApiModel(
    context: Context,
    ...
    override fun getResponseModel(): ApiResponse = SetLimitResponse()
